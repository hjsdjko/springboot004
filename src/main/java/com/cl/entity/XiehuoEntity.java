 ...
 */
@TableName("xiehuo")
public class XiehuoEntity<T> implements Serializable {
	 ...
	 * 设置：卸货时间
	 */
	public void setXiehuoshijian(Date xiehuoshijian) {
		this.xiehuoshijian = xiehuoshijian;
	}
	/**
	 * 获取：卸货时间
	 */
	public Date getXiehuoshijian() {
		return xiehuoshijian;
	}
	/**
	 * 设置：状态
	 */
