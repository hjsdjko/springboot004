...
public class DingdanwanchengController {
    ...
    public R page(@RequestParam Map<String, Object> params,DingdanwanchengEntity dingdanwancheng,
		...
		if(tableName.equals("huozhu")) {
			dingdanwancheng.setHuozhuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("siji")) {
			dingdanwancheng.setSijizhanghao((String)request.getSession().getAttribute("username"));
		}
